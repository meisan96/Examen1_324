        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-black display-4" href="../"><span class="mbri-home mbr-iconfont mbr-iconfont-btn"></span>
                    ...
                    <li class="nav-item"><a class="nav-link link text-black display-4" href="/fcpn/usuario/notas/" aria-expanded="true"><span class="mobi-mbri mobi-mbri-users mbr-iconfont mbr-iconfont-btn"></span><?php 
                        if($_SESSION['rol']==1){
                            echo "Notas";
                        }
                        else{
                ...
                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-primary display-4" href="/fcpn/config/cerrar.php"><span class="mobi-mbri mobi-mbri-paper-plane mbr-iconfont mbr-iconfont-btn"></span>Cerrar Sesion</a></div>
            </div>
        </div>
    </nav>
</section>
